...
<html dir="ltr" lang="en">
  ...
  <body>
    ...
    <!--            </li>-->
    <!--            <li class="cool-link active"><a href="T&C.html">T&C</a></li>-->
    <!--            <li class="cool-link">-->
        ...
        <div class="row">
          <div class="col-md-12 text-right">
            <ol class="breadcrumb">
              ...
              <li><a href="#">Home</a></li>
              <li class="active">Special Components</li>
            </ol>
          </div>
        </div>
      </div>
          ...
          <div class="row">
              <div class="col-md-3 col-sm-12 col-xs-12">
                  <div class="solution_tabs">
                      <h3>Services</h3>
                      <ul>
                          <li class="active"><a href="services.html">Precious Machining Components</a></li>
                          <li><a href="#"> Fabrication Dishends </a></li>
              ...
              <div class="col-md-9 col-sm-12 col-xs-12">
                ...
                <div class="pdf-container">
                  <embed
                    src="images/pdf/QY-manhole cover series.pdf"
